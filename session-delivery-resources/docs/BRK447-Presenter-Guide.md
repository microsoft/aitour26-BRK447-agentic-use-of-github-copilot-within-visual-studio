...
- Review the Initial Setup guide and recorded setup video: `../01-Initial-Setup/brk447-01-Initial Setup-en-US-02-userguide.md` (include the recorded setup video in the same folder as pre-setup material)
...
| Architecture / Zava Overview | High-level architecture and key components — keep to the big picture. | [`../02-Zava-Overview/brk447-02-Zava Overview-en-US-01-minimal.md`](../02-Zava-Overview/brk447-02-Zava%20Overview-en-US-01-minimal.md) |
| Copilot Features in Visual Studio | Ask vs Agent modes, completions, and quick edits inside Visual Studio. | [`../03-VS2022-and-GHCP-Overview/brk447-03-VS2022 and GHCP Overview-en-US-01-minimal.md`](../03-VS2022-and-GHCP-Overview/brk447-03-VS2022%20and%20GHCP%20Overview-en-US-01-minimal.md) |
| AI Search & Unit Testing | TDD flow with Copilot scaffolding unit tests and validating results. | [`../04-Add-single-unit-Test-for-AI-Search/brk447-04 Add single unit Test for AI Search-en-US-01-minimal.md`](../04-Add-single-unit-Test-for-AI-Search/brk447-04%20Add%20single%20unit%20Test%20for%20AI%20Search-en-US-01-minimal.md) |
| MCP Servers | Brief explanation and one quick verification of a configured MCP tool. | [`../05-add-mcp-servers/brk447-05 add mcp servers-en-US-01-minimal.md`](../05-add-mcp-servers/brk447-05%20add%20mcp%20servers-en-US-01-minimal.md) |
| Querying Documentation (MCP) | Show how the Agent can consult Microsoft Learn or other docs to suggest code changes. | [`../06-query-mcp-ms-learn/brk447-06-query mcp ms learn-en-US-01-minimal.md`](../06-query-mcp-ms-learn/brk447-06-query%20mcp%20ms%20learn-en-US-01-minimal.md) |
| Issue-Driven Development with Agent | Show the issue briefly and the Agent's plan/patch workflow (use a short prerecorded clip if long). | [`../07-Implement-unit-tests-using-GH-Issue/brk447-07-Implement unit tests using GH Issue-en-US-01-minimal.md`](../07-Implement-unit-tests-using-GH-Issue/brk447-07-Implement%20unit%20tests%20using%20GH%20Issue-en-US-01-minimal.md) |
| Image-Based UI Updates | Show before/after images and the Agent's suggested UI changes (use recorded clip if applying changes is time-consuming). | [`../08-update-ui-using-agent-based-on-images/brk447-08-update ui using agent based on images-en-US-01-minimal.md`](../08-update-ui-using-agent-based-on-images/brk447-08-update%20ui%20using%20agent%20based%20on%20images-en-US-01-minimal.md) |
| Implement Payment Service | Show how Coding Agent can implement a full Payment service (use recorded clip if applying changes is time-consuming). | [`../09-coding-agent-implement-payment-PRD/brk447-09-coding-agent-implement-payment-PRD-en-US-01-minimal.md`](../09-coding-agent-implement-payment-PRD/brk447-09-coding-agent-implement-payment-PRD-en-US-01-minimal.md) |
