...
# Applying ZAVA Brand Styles to a Blazor App with GitHub Copilot / Compiler
...
Target outcome: Replace the default color scheme with the ZAVA brand style and iteratively improve readability and layout.
...
1. Open your Blazor project in your IDE or code host (the demo uses a repository containing ZAVA style assets).
2. Confirm the objective: replace the current/default colors with the ZAVA brand style and improve UI styling across the app.
...
5. In the same input, add a clear prompt describing the desired outcome. Example prompt:
   - "Apply the ZAVA brand colors and style to this Blazor app. Use the pasted CSS and reference images. Improve readability and ensure product cards and cart visuals match the brand."
...
3. Provide a clear instruction referencing the screenshot. Example:
   - "Screenshot attached — text contrast on product cards is poor. Please adjust the ZAVA palette to improve readability for this component and suggest spacing fixes."
...
3. Add a product to the cart and review the cart UI:
   ...
   - Verify styling consistency with ZAVA brand colors
